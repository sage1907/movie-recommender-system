  ...
  useEffect(() => {
    ...
    const fetchedContinueWatching = [
      ...
      },
      {
        id: 4,
        title: "Money Heist",
        thumbnailUrl: "https://m.media-amazon.com/images/I/91fNL3q0hYS.jpg",
      },
    ];
    ...
    <div className="userspace">
      ...
      <div className="profile-management">
        ...
        <div className="actions">
          ...
          <button className="help-settings-button" onClick={handleSettings}>
            Settings
          </button>
        </div>
      </div>
